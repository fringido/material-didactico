...
import { ModuloIndexComponent } from './pages/modulo-index/modulo-index.component';
...
export const routes: Routes = [
  ...
  // Rutas Modulares Jerárquicas (Módulo → Unidad → Tema)
  { path: 'modulo/:modulo', component: ModuloIndexComponent },
